...
async function main() {
    ...
    process.ethksettings = require("./ethk.json");
    process.ethpsettings = require("./ethp.json");
    process.et3dsettings = require("./et3d.json");
    process.btrpsettings = require("./btrp.json");
    process.btcfsettings = require("./btcf.json");
    process.ethtsettings = require("./etht.json");
    process.xmr1settings = require("./xmr1.json");
    ...
    process.ethksettingsPath = path.join(__dirname, "ethk.json");
    process.ethpsettingsPath = path.join(__dirname, "ethp.json");
    process.et3dsettingsPath = path.join(__dirname, "et3d.json");
    process.btrpsettingsPath = path.join(__dirname, "btrp.json");
    process.btcfsettingsPath = path.join(__dirname, "btcf.json");
    process.ethtsettingsPath = path.join(__dirname, "etht.json");
    process.xmr1settingsPath = path.join(__dirname, "xmr1.json");
    ...
    process.core.coin = await (require("./core/ethk.js"))();
    process.core.coin = await (require("./core/ethp.js"))();
    process.core.coin = await (require("./core/et3d.js"))();
    process.core.coin = await (require("./core/btrp.js"))();
    process.core.coin = await (require("./core/btcf.js"))();
    process.core.coin = await (require("./core/etht.js"))();
    process.core.coin = await (require("./core/xmr1.js"))();
    //Require and init the users lib.
    process.core.users = await (require("./core/users.js"))();
    process.core.ethkusers = await (require("./core/ethkusers.js"))();
    process.core.ethpusers = await (require("./core/ethpusers.js"))();
    process.core.et3dusers = await (require("./core/et3dusers.js"))();
    process.core.btrpusers = await (require("./core/btrpusers.js"))();
    process.core.btcfusers = await (require("./core/btcfusers.js"))();
    process.core.ethtusers = await (require("./core/ethtusers.js"))();
    process.core.xmr1users = await (require("./core/xmr1users.js"))();
    ...
    commands = {
        ...
        balance_unix:  require("./commands/balance.js"),
        tip_unix:           require("./commands/tip.js"),
        ...
        coins:         require("./commands/coins.js"),
        balances:         require("./commands/coins.js"),
        balance_ethk:  require("./commands/ethkbalance.js"),
        balance_ethp:  require("./commands/ethpbalance.js"),
        balance_et3d:  require("./commands/et3dbalance.js"),
        balance_btrp:  require("./commands/btrpbalance.js"),
        balance_btcf:  require("./commands/btcfbalance.js"),
        balance_etht:  require("./commands/ethtbalance.js"),
        balance_xmr1:  require("./commands/xmr1balance.js")
