...
async function main() {
    ...
    process.settings = require("./ethp.json");
    //Load it's path separately so we can write to it without writing the path.
    process.settingsPath = path.join(__dirname, "ethp.json");
    ...
    process.core.users = await (require("./core/ethpusers.js"))();
    ...
    commands = {
        ...
        b_ethp:             require("./commands/ethpbalance.js"),
