...
module.exports = async (msg) => {
    ...
    if (msg.text[1]) {
        ...
        msg.obj.reply(pools[pool].printName + " has " + (await process.core.ethtusers.getBalanceETHT(pool)).toString() + " " + process.ethtsettings.coin.symbol + ".");
        return;
    }
...
msg.obj.reply({ embed });
    ...
    //msg.obj.reply("You have " + (await process.core.ethtusers.getBalanceETHT(msg.sender)).toString() + " " + process.ethtsettings.coin.symbol + ".");
};
