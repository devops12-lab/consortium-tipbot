...
module.exports = async (msg) => {
    ...
    if (msg.text[1]) {
        ...
        msg.obj.reply(pools[pool].printName + " has " + (await process.core.btrpusers.getBalanceBTRP(pool)).toString() + " " + process.btrpsettings.coin.symbol + ".");
        return;
    }
...
msg.obj.reply({ embed });
    ...
    //msg.obj.reply("You have " + (await process.core.btrpusers.getBalanceBTRP(msg.sender)).toString() + " " + process.btrpsettings.coin.symbol + ".");
};
