...
module.exports = async (msg) => {
    ...
    if (msg.text[1]) {
        ...
        msg.obj.reply(pools[pool].printName + " has " + (await process.core.xmr1users.getBalanceXMR1(pool)).toString() + " " + process.xmr1settings.coin.symbol + ".");
        return;
    }
...
msg.obj.reply({ embed });
    ...
    //msg.obj.reply("You have " + (await process.core.xmr1users.getBalanceXMR1(msg.sender)).toString() + " " + process.xmr1settings.coin.symbol + ".");
};
