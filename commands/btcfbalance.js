...
module.exports = async (msg) => {
    ...
    if (msg.text[1]) {
        ...
        msg.obj.reply(pools[pool].printName + " has " + (await process.core.btcfusers.getBalanceBTCF(pool)).toString() + " " + process.btcfsettings.coin.symbol + ".");
        return;
    }
...
msg.obj.reply({ embed });
    ...
    //msg.obj.reply("You have " + (await process.core.btcfusers.getBalanceBTCF(msg.sender)).toString() + " " + process.btcfsettings.coin.symbol + ".");
};
