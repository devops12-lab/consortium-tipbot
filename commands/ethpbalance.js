...
module.exports = async (msg) => {
    ...
    if (msg.text[1]) {
        ...
        msg.obj.reply(pools[pool].printName + " has " + (await process.core.ethpusers.getBalanceETHP(pool)).toString() + " " + process.ethpsettings.coin.symbol + ".");
        return;
    }
...
msg.obj.reply({ embed });
    ...
    //msg.obj.reply("You have " + (await process.core.ethpusers.getBalanceETHP(msg.sender)).toString() + " " + process.ethpsettings.coin.symbol + ".");
};
