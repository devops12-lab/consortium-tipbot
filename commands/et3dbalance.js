...
module.exports = async (msg) => {
    ...
    if (msg.text[1]) {
        ...
        msg.obj.reply(pools[pool].printName + " has " + (await process.core.et3dusers.getBalanceET3D(pool)).toString() + " " + process.et3dsettings.coin.symbol + ".");
        return;
    }
...
msg.obj.reply({ embed });
    ...
    //msg.obj.reply("You have " + (await process.core.et3dusers.getBalanceET3D(msg.sender)).toString() + " " + process.et3dsettings.coin.symbol + ".");
};
