...
async function main() {
    ...
    process.settings = require("./et3d.json");
    //Load it's path separately so we can write to it without writing the path.
    process.settingsPath = path.join(__dirname, "et3d.json");
    ...
    process.core.users = await (require("./core/et3dusers.js"))();
    ...
    commands = {
        ...
        b_et3d:             require("./commands/et3dbalance.js"),
