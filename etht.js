...
async function main() {
    ...
    process.settings = require("./etht.json");
    //Load it's path separately so we can write to it without writing the path.
    process.settingsPath = path.join(__dirname, "etht.json");
    ...
    process.core.users = await (require("./core/ethtusers.js"))();
    ...
    commands = {
        ...
        b_etht:             require("./commands/ethtbalance.js"),
