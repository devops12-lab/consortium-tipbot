...
async function main() {
    ...
    process.settings = require("./xmr1.json");
    //Load it's path separately so we can write to it without writing the path.
    process.settingsPath = path.join(__dirname, "xmr1.json");
    ...
    process.core.users = await (require("./core/xmr1users.js"))();
    ...
    commands = {
        ...
        b_xmr1:             require("./commands/xmr1balance.js"),
