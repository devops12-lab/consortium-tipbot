...
async function main() {
    ...
    process.settings = require("./btrp.json");
    //Load it's path separately so we can write to it without writing the path.
    process.settingsPath = path.join(__dirname, "btrp.json");
    ...
    process.core.users = await (require("./core/btrpusers.js"))();
    ...
    commands = {
        ...
        b_btrp:             require("./commands/btrpbalance.js"),
