...
async function main() {
    ...
    process.settings = require("./btcf.json");
    //Load it's path separately so we can write to it without writing the path.
    process.settingsPath = path.join(__dirname, "btcf.json");
    ...
    process.core.users = await (require("./core/btcfusers.js"))();
    ...
    commands = {
        ...
        b_btcf:             require("./commands/btcfbalance.js"),
